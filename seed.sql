...
SELECT id, 'Elena Fabbri', NULL, date('now', '+7 days')
FROM ricerche WHERE nome = 'Monitoraggio comete';

INSERT INTO richieste (ricerca_id, osservatore, co_osservatori, giorno_richiesto)
SELECT id, 'Davide Manzoni', 'Sara Ferretti', date('now', '+7 days')
...
INSERT INTO richieste (ricerca_id, osservatore, co_osservatori, giorno_richiesto)
SELECT id, 'Chiara Bellandi', 'Luca Toselli', date('now', '+15 days')
FROM ricerche WHERE nome = 'Monitoraggio comete';
